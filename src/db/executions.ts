...
export async function createExecution(db: Database,params: CreateExecutionParams): Promise<Execution | undefined> {
...
export async function listExecutionsByUserID(db: Database, userID: string): Promise<Execution[] | undefined> {
    const sql = `
        SELECT * 
        FROM executions 
        WHERE user_id = ? 
...
export async function listExecutionsByRobotInstanceID(db: Database, userID: string, robotInstanceID: string): Promise<Execution[] | undefined> {
    const sql = `
        SELECT * 
        FROM executions 
...
export async function listExecutionsByStatus(db: Database, userID: string, status: Execution["status"]): Promise<Execution[] | undefined> {
    const sql = `
        SELECT *
        FROM executions
...
export async function updateExecution(db: Database, id: string, userID: string,params: UpdateExecutionParams) {
...
export async function deleteExecution(db: Database, userID: string, id: string): Promise<boolean> {
    const sql = `
