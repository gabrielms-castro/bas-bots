...
export async function createRobotInstance(
  db: Database,
  params: CreateRobotInstanceParams,
): Promise<RobotInstance | undefined> {
  const id = randomUUID();
  const sql = `
...
export async function listAllRobotInstancesByUser(
  db: Database,
  userID: string,
...
export async function getRobotInstanceByID(
  db: Database,
  id: string,
): Promise<RobotInstance | undefined> {
  const sql = `
...
export async function updateRobotInstance(
  db: Database,
  id: string,
  userID: string,
  params: UpdateRobotInstanceParams,
): Promise<RobotInstance | undefined> {
...
export async function deleteRobotInstance(
  db: Database,
  id: string,
  userID: string,
): Promise<boolean> {
